...
Version: 1.0.0
Author: Hex Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Hex Calculator by www.calculator.io";

function display_calcio_ci_hex_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_hex_calculator', 'display_calcio_ci_hex_calculator' );